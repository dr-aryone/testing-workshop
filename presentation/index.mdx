import { condensed, syntaxHighlighterPrism, aspect } from "@mdx-deck/themes";
import theme from "./theme";
import { Head } from "@mdx-deck/components";

export const themes = [condensed, syntaxHighlighterPrism, aspect, theme];
...
#### If you struggle to test something, you fucked up
...
- Never put the blame on the test, he just want to help
